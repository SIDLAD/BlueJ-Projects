...
class chat
{
    static int rep=1,exit=0;
    static String username="";
    static BufferedReader in=new BufferedReader(new InputStreamReader(System.in));
    static int j=0;
    static String arrq[]=new String[2000000];
    static String arrans[]=new String[2000000];
    ...
    public static void room(String inp,String ori) throws Exception
    {
        ...
        else if(inp.toLowerCase().contains(" go ")||inp.toLowerCase().contains(" going ")||inp.toLowerCase().contains(" goes ")||inp.toLowerCase().contains(" end ")||inp.toLowerCase().contains(" bye ")||inp.toLowerCase().contains(" goodbye ")||inp.toLowerCase().contains(" quiet ")||((inp.toLowerCase().contains(" you ")||inp.toLowerCase().contains(" u "))&&(inp.toLowerCase().contains(" later ")||inp.toLowerCase().contains(" l8r ")||inp.toLowerCase().contains(" tomorrow ")||inp.toLowerCase().contains(" next "))))
        {
    ...
    public static void yname() throws Exception
    {
    ...
    public static void mname(String inp) throws Exception
    {
        if(!inp.matches("^[ A-Za-z]+$"))
        {
            inp=inp.replaceAll("[^a-zA-Z0-9/+\\-*=^<>\']", " ");
    ...
    public static void yes_no_be(String inp) throws Exception
    {
    ...
    public static void yes_no_fine(String inp) throws Exception
    {
